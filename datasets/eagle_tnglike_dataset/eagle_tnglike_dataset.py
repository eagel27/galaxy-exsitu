...
_DESCRIPTION = """
Maps of EAGLE (TNG like) galaxy dataset along with their stellar assembly data.
...
class EagleTngLikeDataset(tfds.core.GeneratorBasedBuilder):
    """ DatasetBuilder for tng_dataset dataset. """

    VERSION = tfds.core.Version('2.0.0')
    RELEASE_NOTES = {
      '1.0.0': 'Initial release.',
      '2.0.0': 'Keep only ex-situ fractions < 0.85'
    }
