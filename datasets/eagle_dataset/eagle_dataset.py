...
_DESCRIPTION = """
Maps of RefL0100N1504 EAGLE galaxy dataset along with their stellar assembly data.
Data is extracted from:
 ...
 - H5PY file of stellar assembly 
  (/home/eirini/Documents/PhD/Data/EAGLE/RefL0100N1504/postprocessing/stellar_assembly/exsitu_028.h5py)
...
# TODO(eagle_dataset): BibTeX citation
_CITATION = """
"""


class EagleDataset(tfds.core.GeneratorBasedBuilder):
    """ DatasetBuilder for eagle_dataset dataset. """
    ...
    def _generate_examples(self, split_ids):
        ...
        balanced_data = pd.read_hdf(const.EAGLE_BALANCED_DATASET_ALIGNS_PATH, '/data')
        ...
        for (galaxy_id, snap) in split_ids:
            try:
                ...
                print("Galaxy id not added to the dataset: object_id=", galaxy_id,
                      "ex situ fraction ", exsitu_fraction)
